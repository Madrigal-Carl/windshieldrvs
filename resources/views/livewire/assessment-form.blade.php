<div class="bg-gray-50 w-full">
            ...
            <div>
                ...
                @if ($currentStep === 2)
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="bg-white rounded-xl shadow-md overflow-hidden p-8">
                            <h3 class="font-semibold text-primary mb-4">Assessor Name <span
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        @php
                            ...
                            $roofAnchorOptions = [
                                [
                                    'value' => 'proper-bolted',
                                    'label' =>
                                        'Proper bolted / welded anchors & straps (Maayos at matatag ang pagkakabit)',
                                    'image' => asset('images/unknown_building.png'),
                                    'percentage' => 0,
                                ],
                                [
                        ...
                        @if ($roofMade !== 'concrete-slab')
                            ...
                            <livewire:image-question question="1.3  How is the roof anchored to the structure?"
                                subtitle="Paano nakakabit ang bubong sa istruktura?" :options="$roofAnchorOptions"
                                model="roofAnchor" wire:key="roofAnchor-question" :maxValue="5" :value="$roofAnchor" />
                        ...
                        @php
                            $trussMaterialOptions = [
                                ...
                                [
                                    ...
                                    'label' =>
                                        'Hybrid Truss/Wood and steel (Pinagsamang trases na gawa sa kahoy at bakal)',
                                    'image' => asset('images/unknown_building.png'),
                                    'percentage' => 75,
                                ],
                                [
                ...
                @if ($currentStep === 5)
                    <div class="flex flex-col gap-4">
                        ...
                        @php
                            ...
                            $roofWallQualityOptions = [
                                ...
                                [
                                    ...
                                    'label' =>
                                        'Good quality, minor corrosion (Maganda ang kalidad, may konting kalawang)',
                                    'image' => asset('images/unknown_building.png'),
                                    'percentage' => 25,
                                ],
                                [
                        ...
                        <livewire:image-question
                            question="3.1	Are there proper roof-to-wall connections (ties/anchors)?"
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        @if ($walls)
                            <livewire:image-question-v2 question="4.1 What type of material are the walls made of?"
                                ...
                                wire:key="wallType-question" :maxValue="7" :value="$wallType"
                                :baseValue="$walls" />
                ...
                @if ($currentStep === 7)
                    <div class="flex flex-col gap-4">
                        ...
                        <livewire:image-question question="5.1 Are there signs of settlement or tilt?"
                            subtitle="Mayroon bang sensyales ng paglubog ng lupa o pagtagilid ng pader?"
                            :options="$signsTiltOptions" model="signsTilt" wire:key="signsTilt-question" :maxValue="7"
                            :value="$signsTilt" />
                    </div>
                @endif
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        @if ($doors)
                            <livewire:image-question-v2 question="6.1 What type of doors does the building have?"
                                subtitle="Ano ang uri ng pinto ang mayroon sa gusali?" :options="$doorTypeOptions"
                                model="doorType" wire:key="doorType-question" :maxValue="3" :value="$doorType"
                                :baseValue="$doors" />

                            <livewire:image-question-v2
                                question="6.2 Do the doors swing/slide properly and is it well sealed?"
                                subtitle="Maayos bang bumubukas/sumasara ang pinto at seyado ba ito?"
                                :options="$doorConditionOptions" model="doorCondition" wire:key="doorCondition-question"
                                :maxValue="2" :value="$doorCondition" :baseValue="$doors" />
                            ...
                            <livewire:image-question-v3
                                question="6.4 How many secured and anchored door/window frames?"
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        @if ($columns)
                            <livewire:image-question-v2 question="7.1 What is the shape of the columns? "
                                ...
                                wire:key="columnShape-question" :maxValue="2" :value="$columnShape"
                                :baseValue="$columns" />

                            <livewire:image-question-v2 question="7.2 What is the material of the columns? "
                                subtitle="Anong materyales ang ginagamit sa haligi?" :options="$columnMadeOptions"
                                model="columnMade" wire:key="columnMade-question" :maxValue="2"
                                :value="$columnMade" :baseValue="$columns" />
                        @endif
                        ...
                        @if ($beams)
                            <livewire:image-question-v2 question="7.3 What is the shape of the beams? "
                                ...
                                wire:key="beamShape-question" :maxValue="2" :value="$beamShape"
                                :baseValue="$beams" />
                            ...
                            <livewire:image-question-v2 question="7.4 What is the material of the beams? "
                                ...
                                wire:key="beamMade-question" :maxValue="2" :value="$beamMade"
                                :baseValue="$beams" />
                        @endif
                ...
                @if ($currentStep === 10)
                    <div class="flex flex-col gap-4">
                        ...
                        @php
                            ...
                            $houseRatioOptions = [
                                ...
                                [
                                    ...
                                    'label' =>
                                        'Moderate slenderness (Katamtamang proprosyon ng taas at lapad ng bahay)',
                                    'image' => asset('images/unknown_building.png'),
                                    'percentage' => 50,
                                ],
                                [
                        ...
                        <livewire:image-question question="8.2 How tall is your house?"
                            subtitle="Gaano katas ang bahay?" :options="$houseHeightOptions" model="houseHeight"
                            wire:key="houseHeight-question" :maxValue="3" :value="$houseHeight" />
                        ...
                        @php
                            ...
                            $eavesOptions = [
                                ...
                                [
                                    'value' => 'eaves-loose',
                                    'label' =>
                                        'Loose / corroded fasteners (Maluwag/kinakalawang na ang mga turnilyo/pako)',
                                    'image' => asset('images/unknown_building.png'),
                                    'percentage' => 75,
                                ],
                                [
                ...
                @if ($currentStep === 12)
                    <div class="flex flex-col gap-4">
                        ...
                        @php
                            $houseNumberOptions = [
                                [
                                    ...
                                    'label' =>
                                        'High density (Many obstructions / sheltered) (Marami ang bilang ng bahay)',
                                    'image' => asset('images/unknown_building.png'),
                                    'percentage' => 0,
                                ],
                                [
                        ...
                        <livewire:image-question
                            question="10.1 How would you describe the number of houses in your area?"
                        ...
                        <div class="flex flex-col items-center justify-between gap-8 mb-12">
                            <div class="relative w-54 h-54">
                                ...
                                <div class="absolute inset-0 flex flex-col items-center justify-center">
                                    <span class="text-3xl font-bold mb-2 {{ $textColorClass }}"
                                        id="score-percentage">
                                        {{ $riskLevel }}
                                    </span>
    ...
    @endif
    @if ($currentStep < $totalSteps)
        <div class="container mx-auto px-4 py-18 max-w-3xl">
                ...
                <div class="p-6 md:p-8 space-y-14">
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">1. Roof Type & Condition (Uri at Kondisyon ng
                                Bubong)</h2>
                            <div class="flex justify-between items-center mt-1">
                                <span class="text-sm text-gray-500">Total Vulnerability Score: 20%</span>
                                <span class="text-xs bg-yellow-500/15 text-yellow-500 px-2 py-1 rounded-full">Medium
                                    Risk</span>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <!-- 1.1 -->
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">1.1 What is the roof made of? (Saan gawa
                                    ang Bubong?)</p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['roofMade'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- 1.2 -->
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">1.2 What Type of roof does the house have?
                                    (Ano ang uri ng bubong ng bahay?)</p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['roofType'] ?? 0) / 6) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['roofType'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- 1.3 -->
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">1.3 How is the roof anchored to the
                                    structure?
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['roofAnchor'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- 1.4 -->
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">1.4 What is the current condition of the
                                    roof?
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['roofCondition'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                ...
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    ...
                                    <span class="text-xs text-white mr-1">{{ $trussSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            ...
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">2.1 Are there roof trusses present? (May
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['trussMaterial'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>

                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">2.3 What is the condition of the truss
                                    connection and bracing? (Ano ang kalagayan ng mga dugtungan at brace ng trases?)
                                </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['trussCondition'] ?? 0) / 6) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['trussCondition'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">3. Roof – to – Wall Connection (Koneksyon ng
                                Bubong
                                at Pader)</h2>
                            <div class="flex justify-between items-center mt-1">
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                ...
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    style="width: {{ $rwcFill }}%;">
                                    <span class="text-xs text-white mr-1">{{ $rwcSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">3.1 Are there proper roof-towall
                                    connections
                                    (ties/anchors)? (Mayroon bang wastong ties o anchor bolts sa bubong at pader?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['roofWallConnection'] ?? 0) / 4) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['roofWallConnection'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">3.2 What is the quality of the
                                    roof-to-wall
                                    fasteners (nails, screws, bolts)? (Ano ang kalidad ng mga fasteners (pako, turnilyo
                                    at
                                    bolts)?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['roofWallQuality'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">4. Wall Type and Integrity (Uri at Integridad ng
                                Pader) </h2>
                            <div class="flex justify-between items-center mt-1">
                                <span class="text-sm text-gray-500">Total Vulnerability Score: 10%</span>
                                <span class="text-xs bg-yellow-500/15 text-yellow-500 px-2 py-1 rounded-full">Medium
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                @php
                                    ...
                                    $wallsSum =
                                        ($selectedOptions['wallType'] ?? 0) + ($selectedOptions['wallCondition'] ?? 0);
                                    $wallsFill = $wallsMax > 0 ? ($wallsSum / $wallsMax) * 100 : 0;
                                @endphp
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    style="width: {{ $wallsFill }}%;">
                                    <span class="text-xs text-white mr-1">{{ $wallsSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">4.1 What type of material are the walls
                                    made of? (Anong materyales ang ginamit sa pader?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['wallType'] ?? 0) / 7) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['wallType'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>

                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">4.2 What is the condition of the walls?
                                    (Ano
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['wallCondition'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">5. Wall-to-Foundation Connection (Koneksyon ng
                                Pader
                                sa Pundasyon) </h2>
                            <div class="flex justify-between items-center mt-1">
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                ...
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    ...
                                    <span class="text-xs text-white mr-1">{{ $tiltSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">5.1 Are there signs of settlement or tilt?
                                    (Mayroon bang sensyales ng paglubog ng lupa o pagtagilid ng pader?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['signsTilt'] ?? 0) / 7) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['signsTilt'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">6. Openings - Windows and Doors (Mga Bintana at
                                Pinto) </h2>
                            <div class="flex justify-between items-center mt-1">
                                <span class="text-sm text-gray-500">Total Vulnerability Score: 10%</span>
                                <span class="text-xs bg-yellow-500/15 text-yellow-500 px-2 py-1 rounded-full">Medium
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                ...
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    ...
                                    <span class="text-xs text-white mr-1">{{ $openSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">6.1 What type of doors does the building
                                    have?
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['doorType'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">6.2 Do the doors swing/slide properly and
                                    is
                                    it well sealed? (Maayos bang bumubukas/sumasara ang pinto at seyado ba ito?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['doorCondition'] ?? 0) / 2) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['doorCondition'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">6.3 What type of windows are installed?
                                    (Anong
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['windowType'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">6.4 How secure and anchored are the
                                    door/window frames? (Matibay at maayos bang nakakabit ang mga frame ng bintana at
                                    pinto?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['doorwindowFrame'] ?? 0) / 2) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['doorwindowFrame'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">7. Column and Beam System (Sistema ng mga Haligi
                                at Biga) </h2>
                            <div class="flex justify-between items-center mt-1">
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">7.1 What is the shape of the columns? (Ano
                                    ang
                                    hugis ng haligi?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['columnShape'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">7.2 What is the material of the columns?
                                    (Anong materyales ang ginagamit sa haligi?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['columnMade'] ?? 0) / 3) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['columnMade'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">7.3 What is the shape of the beams? (Ano
                                    ang
                                    hugis ng biga?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['beamShape'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">7.4 What is the material of the beams?
                                    (Anong
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['beamMade'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">7.5 What is the current condition of the
                                ...
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['columnbeamCondition'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">8. Building Shape & Plan Configuration (Hugis ng
                                Gusali at Plano) </h2>
                            <div class="flex justify-between items-center mt-1">
                                <span class="text-sm text-gray-500">Total Vulnerability Score: 8%</span>
                                <span class="text-xs bg-yellow-500/15 text-yellow-500 px-2 py-1 rounded-full">Medium
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                ...
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    ...
                                    <span class="text-xs text-white mr-1">{{ $geomSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">8.1 What is the shape of the house? (Ano
                            ...
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">8.2 How tall is your house? (Gaano katas
                                    ang
                                    bahay?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        ...
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['houseHeight'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">8.3 What is the aspect ratio of the house
                                    (Height: Width) (Ano ang proporsyon ng sukat ng taas at lapad ng bahay?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['houseRatio'] ?? 0) / 2) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['houseRatio'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">9. Overhangs & Eaves (Bulada o Nakausling Bahagi
                                ng Bubong)</h2>
                            <div class="flex justify-between items-center mt-1">
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                ...
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    ...
                                    <span class="text-xs text-white mr-1">{{ $overSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">9.1 How long is the roof overhang? (Gaano
                                    kahaba ang bolada o nakausling bahagi ng bubong?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['overhang'] ?? 0) / 3) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['overhang'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">9.2 What is the condition of the eaves and
                                    soffits of the house? (Ano ang kalagayan ng bolada o nakausli at ilalim na bahagi ng
                                    bubong?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['eaves'] ?? 0) / 2) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['eaves'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-accent pl-4">
                            <h2 class="text-lg font-bold text-primary">10. Location / Environmental Exposure (Lokasyon
                                at
                        ...
                        <div class="pb-2">
                            <div class="w-full bg-gray-200 h-4 rounded-lg">
                                ...
                                <div class="bg-accent h-4 rounded-lg flex items-center justify-end"
                                    style="width: {{ $locFill }}%;">
                                    <span class="text-xs text-white mr-1">{{ $locSum }}%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-6 space-y-5 border-l-2 border-gray-100">
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">10.1 How would you describe the number of
                                    houses in your area? (Paano mo ilalarawan ang dami ng bahay sa inyong lugar/) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg"
                                        style="width: {{ (($selectedOptions['houseNumber'] ?? 0) / 3) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['houseNumber'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-1">
                                <p class="text-sm text-gray-700 font-medium">10.2 Where is the location of your house?
                                    (Saan matatagpuan ang inyong bahay?) </p>
                                <div class="w-full bg-gray-200 h-3 rounded-lg relative">
                                    <div class="bg-accent/80 h-3 rounded-lg style="width:
                                        {{ (($selectedOptions['houseLocation'] ?? 0) / 3) * 100 }}%;">
                                        <span
                                            class="absolute text-xs -right-0 top-3.5 text-gray-500">{{ $selectedOptions['houseLocation'] ?? 0 }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
